document.addEventListener('DOMContentLoaded', function() {
    ...
    const games = [
        {
            fileName: 'fallacy1.html',
            title: 'Fallacy Challenge 🤔'
        }, 
        ...
        {
            fileName: 'topicsentence.html',
            title: 'Topic Sentence or Chicken? 🐔'
        },         
        {
            fileName: 'topicsentencebuilder.html',
            title: 'Topic Sentence Racer 🏃🏻‍♂️'
        }, 
        {
        ...
        {
            fileName: 'keywordpowerup.html',
            title: 'Keyword Powerup 🤖'
        }, 
        {
        ...
        }, 
        {
            ...
            title: 'Inquiry Garden: Ask to Grow 🪴'
                         ...
                         {
            fileName: 'CRAAP1.html',
            title: 'CRAAP Challenge'
        }, 
                 {
            fileName: 'sourcesorterdeepdive.html',
            title: 'Source Sorter Deep Dive'
        }, 
         {
            fileName: 'questionquest2.html',
            title: 'Evaluating Good vs. Weak Questions'
        }, 
        {
            fileName: 'factOpinion1.html',
            title: 'Fact vs. Opinion'
        }, 
                {
            fileName: 'questionsorterarcade.html',
            title: 'Question Sorter Arcade'
        }, 
        {
